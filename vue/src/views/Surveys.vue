<template>
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:gird-cols-3">
      <div v-for="survey in surveys"
      :key="survey.id"
      class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 ">
      <img :src="survey.image" alt="" class="w-full h-48 object-cover" style="height:54%"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
        ...
        Edit</router-link>
        <button v-if="survey.id" type="button" @click="deleteSurvey(survey)" class="h-8 w-8 flex items-center justify-center rounded-full border border text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
