<template>
    <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            Or
            {{ ' ' }}
            <router-link :to="{ name: 'Login' }" class="font-medium text-indigo-600 hover:text-indigo-500">Login to your
                account </router-link>
        </p>
    </div>
    <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
             <div>
                ...
                <input id="email-address" name="name" type="text" autocomplete="name" required="" v-model="user.name"
            ...
            <div>
              ...
              <div>
                ...
                <input id="password-confirmation" name="password-confirmation" type="password" autocomplete="current-password-confirmation" required="" v-model="user.password_confirmation"
