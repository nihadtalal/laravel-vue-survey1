<template>
 <div class="py-5 px-8">
    ...
    <div v-if="surveyFinished"
        ...
        focus:outline-none focus:ring-2 focus:ring-offset-2 focus">Submit another response</button>
    </div>
    <div v-else>
        <hr class="my-3"/>
        ...
        <button
        type="submit"
        class="inline-flex justify-center py-2 px-4 border-transparent shadow-sm
        text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700
